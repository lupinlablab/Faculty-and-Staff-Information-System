  ...
  <?php
            ...
            while($test = mysqli_fetch_assoc($result)){
                ...
                <tr>
                        ...
                        <a href = 'edit_faculty.php'  class='btn btn-primary'>Edit</a>
                        <a href = 'delete_faculty.php?id=$test[id]' class = 'btn btn-danger'>Delete </a>
                    </td>
...
<a class="btn btn-primary" href="/Staff&Faculty/Admin/create_faculty.php" role="button">Create</a>
